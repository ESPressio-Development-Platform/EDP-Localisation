...
from .common import FIELD_IDENTIFIER_BYTES, FINGERPRINT_CANONICALISATION_VERSION, TYPE_IDENTIFIER_BYTES
...
def build_fingerprint(model: SemanticModel) -> Fingerprint:
    ...
    s.u8(FIELD_IDENTIFIER_BYTES if model.schema else 0)
